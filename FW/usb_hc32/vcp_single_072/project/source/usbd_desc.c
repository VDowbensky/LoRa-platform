 ...
 ******************************************************************************/
#define USBD_VID                        0X8888       //Equipment Manufacturer ID
#define USBD_PID                        0X8888        //Product ID

/** @defgroup USB_String_Descriptors
  * @{
  */ 
#define USBD_LANGID_STRING              0x409         //This refers to English (United States): American English ID
#define USBD_MANUFACTURER_STRING        "HDSC"
#define USBD_PRODUCT_HS_STRING          "HDSC"
#define USBD_PRODUCT_FS_STRING          "HDSC"
