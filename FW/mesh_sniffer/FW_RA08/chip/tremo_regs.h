...
#define RCC_CR0_MCO_CLK_DIV_16   ((uint32_t)0x01C00000)
...
typedef struct {
    ...
    __IO uint32_t RESV[2];     /*!< reserved, offset 0x38-0x3C */ //WFIFO_CTRL,RFIFO_CTRL???
...
typedef struct {
    ...
    __IO uint32_t SR1;  /*!< status register 1, offset 0x0C */
    __IO uint32_t CR2;  /*!< control register 2, offset 0x10 */
    __IO uint32_t CR3;  /*!< control register 3, offset 0x14 */
    __IO uint32_t CR4;  /*!< control register 4, offset 0x18 */
    __IO uint32_t CR5;  /*!< control register 5, offset 0x1C */
} pwr_t;
