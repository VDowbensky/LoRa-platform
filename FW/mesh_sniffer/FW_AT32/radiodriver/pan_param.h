...
#ifndef  _PAN_PARAMS_H_
#define  _PAN_PARAMS_H_
...
/* Power levels 1..PAN_MAX_RAMP. Indexed by desired power step. */
static const PAN_PowerRampCfg_t g_RfPowerRampCfg[PAN_MAX_RAMP + 1] =
{
...
static const RadioFreqTable_t g_RfFreqTable[] = 
{
  ...
  {138330000,  143330000,  0x2A, 0x0C, 0xC0}, //!< 131.6M  140.2M  148.8M //12
  ...
  {207500000,  215000000,  0x2A, 0x08, 0xB0}, //!< 197.4M  210.3M  223.3M //8
  ...
  {282500000,  287000000,  0x2A, 0x06, 0xA0}, //!< 263.2M  280.3M  297.7M //6
  ...
  {408000000,  415000000,  0x1A, 0x06, 0x90}, //!< 385.0M  408.8M  432.8M //4
  ...
  {505000000,  540000000,  0x7A, 0x06, 0x90}, //!< 457.0M  499.3M  541.5M //560000000
  {810000000,  830000000,  0x1A, 0x02, 0x80}, //!< 770.0M  817.5M  865.5M //2
...
/**
* @brief VCO frequency division coefficient table
* @note This table is used to store the VCO frequency division coefficients.
*/
...
* @note To reduce the computational burden on the MCU, a logarithmic table is used for the conversion.
*/
