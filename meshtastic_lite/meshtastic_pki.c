...
bool meshX25519DH(const uint8_t our_private[32],
                                 const uint8_t their_public[32],
                                 uint8_t shared_out[32]) 
{
...
bool meshCcmEncrypt(const uint8_t key[32],
...
bool meshCcmDecrypt(const uint8_t key[32],
                                    const uint8_t nonce[16],
 ...
 */
size_t meshTryPkiDecrypt(const MeshRxPacket_t *pkt,
                                        const MeshPkiIdentity_t *identity,
                                        const MeshNodeKeyStore_t *key_store,
