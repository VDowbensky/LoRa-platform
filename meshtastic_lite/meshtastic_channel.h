...
uint8_t meshXorHash(const uint8_t *p, size_t len);
 ...
 */
MeshCryptoKey meshExpandPsk(const uint8_t *raw, uint8_t raw_len);
 ...
 */
uint8_t meshComputeChannelHash(const char *effective_name,const MeshCryptoKey *key);
// ─── Channel Table ─────────────────────────────────────────────────────────────

typedef struct MeshChannelTable 
{
